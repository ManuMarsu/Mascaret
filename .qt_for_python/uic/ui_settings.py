...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.bt_pathPostgres.clicked.connect(self.actionBt_pathPostgres.trigger)
        self.txt_path_postgres.textChanged['QString'].connect(self.actionTxt_path_postgres.trigger)
